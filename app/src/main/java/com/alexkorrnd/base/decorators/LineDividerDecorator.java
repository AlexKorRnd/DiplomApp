package com.alexkorrnd.base.decorators;
...
public class LineDividerDecorator extends RecyclerView.ItemDecoration {
    ...
    public LineDividerDecorator(@ColorInt int color, float width) {
        this(color, width, new Rect());
    }

    public LineDividerDecorator(@ColorInt int color, float width, @NonNull Rect margin) {
        this(color, width, margin, 0);
    }

    public LineDividerDecorator(@ColorInt int color, float width, @NonNull Rect margin, int skipFirstCount) {
        this.margin = margin;
